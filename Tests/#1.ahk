...
if (A_ScreenDPI != 96) {
    ...
    MsgBox,	16,zetoirque's Macro, Your Scale `& layout settings need to be on 100`%
    ExitApp
}
...
Gui, 2:Add, Text,xm-8 ym,zetoirquel Macro L to Exit K to Pause
...
Gui, Add, Text,ym xm,zetoirque's Macro
...
Treadmill:
    ...
    Loop,
    {
        ...
        Notify("Clicked, " T4)
        Sleep, 3000
        Button := "z,q,s,d", TreadmillTask := A_TickCount
